...
export default function EditStudent() {
    ...
    const { rollNo } = useParams(); // Get the ID from the URL parameters
    ...
    // Load the student data when the component mounts

    const onSubmit = async (e) => {
        e.preventDefault();
        await axios.put(`http://localhost:8080/student/update/${rollNo}`, student);
